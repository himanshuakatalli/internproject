...
class Features extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'categories' => array(self::MANY_MANY, 'Categories', 'category_has_features(feature_id, category_id)'),
			'products' => array(self::MANY_MANY, 'Product', 'product_has_features(feature_id, product_id)'),
		);
	}
