...
<div class="container" style="margin-top:200px;height:400px">
	...
	<div class="col-sm-4">
		...
		<div class="well" style="padding:30px">
			...
			<?php echo $form->passwordField($reset,'Password',array('class'=>'form-control','data-parsley-required-message'=>'Password is required','placeholder'=>"Password",'data-parsley-minlength'=>"6",'required'=>'required','id'=>'passwordField','data-parsley-required-message'=>'Password is required')); ?>
			<br>
