...
<html>
	<head>
		...
		<script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl; ?>/style/newhome/js/validate.js" ></script>
	</head>
	<body>
		<div class="main">
			<?php echo $content; ?>
							...
							<div class="col-md-6 col-xs-12 rs-np">
								...
								<div class="col-md-12 col-xs-12 rs-nm rs-p11 mt10">
									<?php if(Yii::app()->user->isGuest){
										...
										<?php
											$user = Users::model()->with('role')->findByPk(Yii::app()->user->user_id);
									...
									<div class="col-md-7 col-md-offset-4 col-xs-12">
										<div class="col-md-12 col-xs-12 np text-center">
											<img width="90" height="90" src="<?php echo (!empty($user->profile_img))?$user->profile_img:Yii::app()->theme->baseUrl."/style/newhome/images/pic.png";?>" class="img-circle" alt="Team Member">
											<h2 class="fs16  font_newregular ">Hey! <?php echo $fname;?></h2>
										...
										<div class="col-md-12 col-xs-12 bt mt20 pt20 pb20 text-center np rs-show">
											<?php echo CHtml::link('<span class="icon-home mr5" aria-hidden="true"></span>',array('/'.$role.'/index'),array('class'=>'fs13 font_newregular orange-new col-md-5 col-xs-4 pl0 pr10 mb5')); ?>
											<?php echo CHtml::link('<span class="icon-settings mr5" aria-hidden="true"></span>',array('/'.$role.'/account'),array('class'=>'fs13 font_newregular orange-new col-md-4 np col-xs-4 pl0 pr10 mb5')); ?>
				...
				<div class="modal-content col-md-12 mb30 np">
					...
					<div class="modal-body col-md-12 np p20">
						<p>
							...
							<strong class="orange-new">Personal identification information</strong>
							<br><br>
							...
							<strong class="orange-new">Non-personal identification information</strong><br><br>
							...
							<strong class="orange-new">How we use collected information</strong>
							<br><br>
							...
							<strong class="orange-new">How we protect your information</strong>
							<br><br>
							...
							<strong class="orange-new">Sharing your personal information</strong>
							<br><br>
							We do not sell, trade, or rent Users personal identification information to others. We may share generic aggregated demographic information not linked to any personal identification information regarding visitors and users with our business partners, trusted affiliates and advertisers for the purposes outlined above.
							<br><br>
							<strong class="orange-new">Third party websites</strong>
							<br><br>
							...
							<br><br>
							<strong class="orange-new">Engagement between Development firm and Client</strong>
							<br><br>
							...
							<br><br>
							<strong class="orange-new">Compliance with children's online privacy protection act</strong>
							<br><br>
							...
							<strong class="orange-new">Your acceptance of these terms</strong>
							...
							<strong class="orange-new">Contacting us</strong>
							<br><br>
							If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:
							<br><br>
							<a href="mailto:Questi%6F%6Es@%56%65%6Etur%65Pact%2Ec%6Fm">
