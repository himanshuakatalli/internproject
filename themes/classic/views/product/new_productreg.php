    ...
    <div class="row">
      ...
      <div class="row">
       <div class="input-half">
         ...
         <?php echo $form->textField($product,'starting_price',array('class'=>'col-lg-11 col-md-11 col-sm-11 col-xs-11','placeholder'=>'Starting Prie','required'=>'required','data-parsley-trigger'=>"focusout",'data-parsley-type'=>'digits'));?>
       </div>
      </div>
      <div class="row">
        <div class="input-half-submit">
