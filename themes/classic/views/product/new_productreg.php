...
<body>
  <section class="container prod-reg-container">
    ...
    <form class="container-fluid">
      ...
      <div class="row">
        <div class="input-half-submit">
          <input type="button" value="Company" id="user"></input>
        </div>
      </div>
		</form>	
		</section>
	...
	<form class="container-fluid">
	      ...
	      <div class="row">
        <div class="input-half-submit">
          <input type="button" value="Product" id="company"></input>
        </div>
      </div>
	      </form>
	    </section>
    ...
    <div class="row">
      ...
      <div class="input-half-radio float-right">
       ...
       <div class="input-half">
     	...
     	<div class="row">
        <div class="input-half-submit">
          <input type="button" value="Deployment" id="product"></input>
        </div>
      </div>
     </form>
     </section>
     	...
     	<div class="row">
          ...
          <i class="fa fa-phone"></i>&nbsp;&nbsp;Mobile
           ...
           <i class="fa fa-desktop"></i>&nbsp;&nbsp;Desktop
			...
			<div class="row">
        <div class="input-half-submit">
          <input type="button" value="Media Link" id="deployment"></input>
        </div>
      </div>
     </form>
     </section>
