  ...
  <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl;?>/style/newhome/css/prod.css">
    ...
    <form class="container-fluid">
      ...
      <div class="row">
        <div class="input-half-submit">
          <input type="submit" value="Create my free listing" name="submit"></input>
        </div>
      </div>
    </form>
  </section>