		...
		<div class="media">
			...
			<div class="media-body">
				<div class="col-sm-12 col-md-8 ">
					...
					<h4><small> by <?php echo $product->company_name ?> </small></h4>
				</div>
				<div>
					<?php if($product->under_ppc==0) {
						echo CHtml::link('Visit Profile',array('product/productprofile/', 'id'=>$product->id),array('class' => 'btn btn-primary','type'=>'button'));
					}
					else{
